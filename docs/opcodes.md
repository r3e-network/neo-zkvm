...
| LDLOC0-5  | 0x66-0x6B | 2   | Load local variable 0-5             |
| LDLOC     | 0x6C      | 2   | Load local variable n               |
| STLOC0-5  | 0x6D-0x72 | 2   | Store local variable 0-5            |
| STLOC     | 0x73      | 2   | Store local variable n              |
| LDARG0-5  | 0x74-0x79 | 2   | Load argument 0-5                   |
| LDARG     | 0x7A      | 2   | Load argument n                     |
| STARG0-5  | 0x7B-0x80 | 2   | Store argument 0-5                  |
...
| Opcode       | Hex  | Gas | Description                        |
| ------------ | ---- | --- | ---------------------------------- |
| PACKMAP      | 0xBE | 8   | Pack items into map                |
| PACKSTRUCT   | 0xBF | 8   | Pack items into struct             |
| PACK         | 0xC0 | 8   | Pack items into array              |
| UNPACK       | 0xC1 | 8   | Unpack array to stack              |
| NEWARRAY0    | 0xC2 | 8   | Create empty array                 |
| NEWARRAY     | 0xC3 | 8   | Create array with n null elements  |
| NEWARRAY_T   | 0xC4 | 8   | Create typed array                 |
| NEWSTRUCT0   | 0xC5 | 8   | Create empty struct                |
| NEWSTRUCT    | 0xC6 | 8   | Create struct with n null elements |
| NEWMAP       | 0xC8 | 8   | Create empty map                   |
| SIZE         | 0xCA | 8   | Get size of compound type          |
| HASKEY       | 0xCB | 8   | Check if key exists                |
| KEYS         | 0xCC | 8   | Get all keys from map              |
| VALUES       | 0xCD | 8   | Get all values from map            |
| PICKITEM     | 0xCE | 8   | Get item by key/index              |
| APPEND       | 0xCF | 8   | Append item to array               |
...
│  2 gas:    NOP, JMP*, CALL, RET, SYSCALL, DUP, DROP, SWAP     │
│            INITSLOT, LDLOC*, STLOC*, LDARG*, STARG*         │
│            SETITEM, REMOVE, CLEARITEMS, POPITEM              │
